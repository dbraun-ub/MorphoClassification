...
declare -a configs=(
    ...
    "convnext_tiny_005 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 0 1 2 3 5 6 7 8 --val_folds 9 --test_folds 4 --model_name convnext_tiny --num_epoch_unfreeze 10 --earlyStopping_patience 10 --learning_rate 0.001 --dataset ThreeViewsDataset --image_size 3 224 320 --scheduler_step_size 10 --drop_rate 0"
    "convnext_tiny_006 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 0 1 3 4 5 6 7 9 --val_folds 2 --test_folds 8 --model_name convnext_tiny --num_epoch_unfreeze 10 --earlyStopping_patience 10 --learning_rate 0.001 --dataset ThreeViewsDataset --image_size 3 224 320 --scheduler_step_size 10 --drop_rate 0"
