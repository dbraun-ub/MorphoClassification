...
declare -a configs=(
    ...
    "convnext_tiny_006 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 0 2 4 5 6 7 8 9 --val_folds 1 --test_folds 3 --model_name convnext_tiny --num_epoch_unfreeze 5 --earlyStopping_patience 10 --learning_rate 0.001 --dataset ThreeViewsDataset --image_size 3 224 320 --scheduler_step_size 10 --drop_rate 0 --progressive_unfreeze --progressive_unfreeze_step 5"
