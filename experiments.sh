...
declare -a configs=(
    ...
    "convnext_tiny_021 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 0 2 3 4 5 6 7 9 --val_folds 8 --test_folds 1 --model_name convnext_tiny --num_epoch_unfreeze 10 --earlyStopping_patience 10 --learning_rate 0.001 --dataset FrontViewDatasetV2 --image_size 3 640 240 --scheduler_step_size 10 --drop_rate 0"
    ...
    "convnext_tiny_024 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 0 2 3 4 5 6 7 9 --val_folds 8 --test_folds 1 --model_name convnext_tiny --num_epoch_unfreeze 10 --earlyStopping_patience 10 --learning_rate 0.001 --dataset ThreeViewsDatasetV2 --image_size 3 224 224 --scheduler_step_size 10 --drop_rate 0"
    # "convnext_tiny_025 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 0 2 4 5 6 7 8 9 --val_folds 1 --test_folds 3 --model_name convnext_tiny --num_epoch_unfreeze 10 --earlyStopping_patience 10 --learning_rate 0.001 --dataset ThreeViewsDatasetV2 --image_size 3 224 224 --scheduler_step_size 10 --drop_rate 0"
    # "convnext_tiny_026 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 1 2 3 4 6 7 8 9 --val_folds 5 --test_folds 0 --model_name convnext_tiny --num_epoch_unfreeze 10 --earlyStopping_patience 10 --learning_rate 0.001 --dataset ThreeViewsDatasetV2 --image_size 3 224 224 --scheduler_step_size 10 --drop_rate 0"
