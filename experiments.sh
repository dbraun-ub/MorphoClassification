...
declare -a configs=(
    ...
    # "convnext_tiny_015 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 1 2 3 4 6 7 8 9 --val_folds 5 --test_folds 0 --model_name convnext_tiny --num_epoch_unfreeze 10 --earlyStopping_patience 10 --learning_rate 0.0001 --dataset ThreeViewsDataset --image_size 3 224 320 --scheduler_step_size 10 --drop_rate 0 --linear_target --batch_size 64 --device cuda"
    ...
    "convnext_tiny_017 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 0 2 4 5 6 7 8 9 --val_folds 1 --test_folds 3 --model_name convnext_tiny --num_epoch_unfreeze 10 --earlyStopping_patience 10 --earlyStopping_min_delta 0 --learning_rate 0.0001 --dataset FrontViewDataset --image_size 3 224 320 --scheduler_step_size 10 --drop_rate 0 --linear_target --batch_size 64 --device cuda"
    "convnext_tiny_018 --data_path /home/ubuntu/data/MORPHO_Batch1 --train_folds 1 2 3 4 6 7 8 9 --val_folds 5 --test_folds 0 --model_name convnext_tiny --num_epoch_unfreeze 10 --earlyStopping_patience 10 --earlyStopping_min_delta 0 --learning_rate 0.0001 --dataset FrontViewDataset --image_size 3 224 320 --scheduler_step_size 10 --drop_rate 0 --linear_target --batch_size 64 --device cuda"
